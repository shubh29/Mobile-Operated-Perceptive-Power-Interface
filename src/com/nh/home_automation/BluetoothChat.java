   ...
   private ArrayAdapter<String> mConversationArrayAdapter;
    ...
    private void setupChat() {
     ...
     mOutEditText = (EditText) findViewById(R.id.edit_text_out);
        ...
        high4=(Button)findViewById(R.id.high4);
        mid4=(Button)findViewById(R.id.mid4);
        low4=(Button)findViewById(R.id.low4);
...
off2.setOnClickListener(new OnClickListener() {
...
off3.setOnClickListener(new OnClickListener() {
...
high4.setOnClickListener(new OnClickListener() {
...
mid4.setOnClickListener(new OnClickListener() {
...
low4.setOnClickListener(new OnClickListener() {
...
off4.setOnClickListener(new OnClickListener() {
